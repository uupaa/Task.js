...
function m(a,c){var b=a.a;if(""===b.state){switch(c){case "init":b.state=n(b);break;case "pass":++b.h;b.state=n(b);break;case "miss":++b.f;b.state=n(b);break;case "exit":b.state="exit"}b.state&&(b.i?(b.d.message(b.message),b.d[b.state]()):b.d("pass"===b.state?e:Error(b.message),a.a.buffer,a),delete l[a.c],a.a.b=e,a.a.buffer=e,a.a.d=e)}return a}function n(a){return a.f>a.e?"miss":a.f+a.h>=a.g?"pass":""}
