var c=this.self||global;function e(b,d,a){a=a||{};var k=a.prefix||"anonymous",m=a.buffer||new f;a=a.j||null;this.c=k+"_"+ ++g;this.a={buffer:m,d:d,g:b,b:a,e:0,h:"",i:0,f:0,state:""};h[this.c]=this;j(this,"init")}
...
e.name="Task";e.dump=function(b){var d={},a;for(a in h)if(!b||b===a.split("_")[0])d[a]=h[a].a;return JSON.parse(JSON.stringify(d))};e.reset=function(){h={};g=0};
