var e=null,f=this.self||global;function g(a,c,b){b=b||{};var d=c instanceof g,l=b.tick||e,m=b.name||"anonymous";b=b.buffer||(d?c.buffer():[]);this.d=m+"@"+ ++h;this.a={c:l,buffer:b,e:c,b:d,h:a,f:0,i:0,g:0,message:"",state:""};j[this.d]=this;a||k(this,"init")}
...
g.prototype={constructor:g,push:function(a){this.a.buffer&&this.a.buffer.push(a);return this},set:function(a,c){this.a.buffer&&(this.a.buffer[a]=c);return this},done:function(a){var c=a instanceof Error;c&&this.message(a.message);return c?this.miss():this.pass()},pass:function(){this.a.c&&this.a.c(this.d);return k(this,"pass")},miss:function(){this.a.c&&this.a.c(this.d);return k(this,"miss")},exit:function(){return k(this,"exit")},buffer:function(){return this.a.buffer},extend:function(a){this.a.h+=
a;return this},message:function(a){this.a.message=a;return this},missable:function(a){this.a.f+=a;return this},isFinished:function(){return""!==this.a.state}};g.dump=function(a){var c={},b;for(b in j)if(!a||a===b.split("@")[0]){var d=j[b].a;c[b]={junction:d.b,taskCount:d.h,missableCount:d.f,passedCount:d.i,missedCount:d.g,state:d.state}}return JSON.parse(JSON.stringify(c))};g.drop=function(){j={};h=0};g.flatten=function(a){return Array.prototype.concat.apply([],a)};g.arraynize=function(a){return Array.prototype.slice.call(a)};
