...
function Task(taskName,  // @arg String               - task name.
              taskCount, // @arg UINT16               - user task count.
...
//{@dev
    if (!global["BENCHMARK"]) {
        ...
        $valid($type(taskCount, "UINT16"),             Task, "taskCount");
...
//}@dev
    ...
    this._taskCount = taskCount;    // UINT16: user task count.
...
Task["prototype"] = Object.create(Task, {
    "constructor":  { "value": Task      }, // new Task(taskName:String, taskCount:UINT16, callback:Function|Task = null, tick:Function = null):Task
    // --- flow state ---
