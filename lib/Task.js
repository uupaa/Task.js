...
//{@dev
    ...
    _if(!Valid.type(options, "Object|omit"),                Task, "options");
    _if(!Valid.keys(options, "tick,name,buffer"),           Task, "options");
//}@dev
...
//{@dev
    ...
    _if(!Valid.type(options,   "Object|omit"),       Task.run, "options");
    _if(!Valid.keys(options,   "arg|name|buffer"),   Task.run, "options");
//}@dev
