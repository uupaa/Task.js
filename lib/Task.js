...
function Task(taskCount, // @arg Integer: task count, value from 1.
              callback,  // @arg Function/JunctionTaskInstance: task finished callback or Junction.
                         //            callback(err:Error, buffer:MappedArray/Array, task:Task)
              options) { // @arg Object(= {}): { prefix, buffer, tick }
                         //        options.prefix - String(= "anonymous"): task name prefix.
                         //        options.buffer - MappedArray/Array(= []): MappedArray instance or Array.
...
//}@assert
    ...
    this._ = {
        buffer:         buffer,     // MappedArray/Array: MappedArray or Array
...
Task["prototype"] = {
    "constructor":  Task,
    // --- buffer accessor ---
    "buffer":       Task_buffer,    // Task#buffer():MappedArray/Array/null
...
// --- implement -------------------------------------------
function Task_buffer() { // @ret MappedArray/Array/null: task finished is null.
                         // @help: Task.Buffer
...
function Task_set(key,     // @arg String:
                  value) { // @arg Any:
                           ...
                           // @help: Task.set
    if (this._.buffer) {
        this._.buffer["set"] ?  this._.buffer["set"](key, value)
