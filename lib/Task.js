...
Task["run"]       = Task_run;       // Task.run(taskRoute:String,
                                    ...
                                    //          options:Object = {}):Task
Task["loop"]      = Task_loop;      // Task.loop(object:Object/Array,
                                    //           tick:Function,
                                    //           callback:Function/Junction,
                                    //           options:Object = {}):Task
// --- implement -------------------------------------------
...
function Task_loop(object,    // @arg Object/Array: for loop and for-in loop data. [1, 2, 3], { a: 1, b: 2, c: 3 }
                   ...
                   options) { // @arg Object(= {}): { arg, name, buffer }
                              ...
                              // @help: Task.loop
//{@assert
    _if(!Valid.type(object, "Object/Array"), "Task.loop(object)");
